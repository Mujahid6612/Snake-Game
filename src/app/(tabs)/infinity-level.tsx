...
import { STORAGE_KEYS, DIFFICULTY_SPEEDS } from "../(tabs)/settings";
...
const SnakeGame = () => {
  ...
  const [gameSpeed, setGameSpeed] = useState(180);
  ...
  const [baseSpeed, setBaseSpeed] = useState(180); // Track original speed separately
      ...
      <View style={styles.container}>
        ...
        {isPaused && (
          <View style={styles.pauseOverlay}>
            <Text
              style={[styles.pausedText, { fontSize: SCREEN_WIDTH * 0.12 }]}
            >
              PAUSED
            </Text>
          </View>
