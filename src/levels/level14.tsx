...
// Keep level14's base speed
const INITIAL_GAME_SPEED = 110;

// Update GAME_ELEMENTS to match level13's powers
const GAME_ELEMENTS = {
  SNAKE_HEAD: "🟢",
  SNAKE_BODY: "🟩",
  FOOD: "🍎",
...
const Level14 = () => {
  ...
  // Keep level14's restricted areas
  ...
  const restartGame = () => {
    ...
    // Reset restricted areas specific to level14
    setRestrictedAreas([
      { x: 2, y: 2, width: 3, height: 3 },
      { x: 15, y: 15, width: 3, height: 3 },
      { x: 2, y: 15, width: 3, height: 3 },
    ...
    // Reset obstacles specific to level14
    setObstacles([
      { x: 5, y: 5 },
      { x: 15, y: 5 },
      { x: 7, y: 7 },
